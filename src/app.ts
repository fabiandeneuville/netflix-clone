...
const faqItemsParagraphsFr : string[] = [
...
const faqItemsParagraphsEn : string[] = [
...
const faqParagraphsList = document.querySelectorAll('.faq-item-paragraph') as NodeListOf<HTMLParagraphElement>;
const faqParagraphsArr : HTMLParagraphElement[] = Array.from(faqParagraphsList);
const faqButtonsList = document.querySelectorAll('.faq-item-button') as NodeListOf<HTMLDivElement>;
const faqButtonsArr : HTMLDivElement[] = Array.from(faqButtonsList);
const faqContentsList = document.querySelectorAll('.faq-item-content') as NodeListOf<HTMLDivElement>;
const faqContentsArr : HTMLDivElement[] = Array.from(faqContentsList);
const faqIconsList = document.querySelectorAll('.faq-item-icon') as NodeListOf<HTMLImageElement>;
const faqIconsArr : HTMLImageElement[] = Array.from(faqIconsList);
/********** FOOTER **********/
...
function renderFaqParagraphs(arrayOfParagraphs : HTMLParagraphElement[], arrayOfTexts : string[]) : void {
...
function openFaqItemContent(button : HTMLDivElement, content : HTMLDivElement, icon : HTMLImageElement) : void {
